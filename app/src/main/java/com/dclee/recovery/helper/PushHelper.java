package com.dclee.recovery.helper;
...
import com.dclee.recovery.bean.net.UmengMsgBean;
    ...
    public static void init(final Context context) {
        ...
        pushAgent.register(new UPushRegisterCallback() {
            ...
            public void onSuccess(String deviceToken) {
                ...
                PreferencesUtils.putString(context, Config.UM_TOKEN, deviceToken);
                //可设置别名，推送时使用别名推送
//                String type = "uid";
//                String alias = "123456";
    ...
    private static void pushAdvancedFunction(Context context) {
        ...
        UmengMessageHandler msgHandler = new UmengMessageHandler() {
            ...
            public void dealWithNotificationMessage(Context context, UMessage msg) {
                ...
                play(context, R.raw.new_order);
                UmengMsgBean umengMsgBean = FastJsonTools.get(msg.getRaw().toString(), UmengMsgBean.class);

                Notification notification = new Notification.Builder(context)
                        .setContentTitle(umengMsgBean.body.title)
                        .setContentText(umengMsgBean.body.text)
                        .setWhen(System.currentTimeMillis())
                        .setSmallIcon(R.mipmap.ic_meicheng)
                        .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_meicheng))
                        .build();
